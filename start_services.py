#!/usr/bin/env python3
"""
Start Services Launcher Script
Starts both the AI Backend (FastAPI on http://localhost:8000)
...
AI_BACKEND_DIR = os.path.join(BASE_DIR, "AI_MODEL", "backend")
AI_FRONTEND_DIR = os.path.join(BASE_DIR, "AI_MODEL", "frontend")
DESIGN_FRONTEND_DIR = BASE_DIR
...
def main():
    ...
    run_service(frontend_cmd, frontend_dir, "FRONTEND")
