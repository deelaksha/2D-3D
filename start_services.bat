...
set FRONTEND_DIR=%SCRIPT_DIR%AI_MODEL\frontend

if not exist "%FRONTEND_DIR%" set FRONTEND_DIR=%SCRIPT_DIR%
...
echo Starting Frontend Service (Next.js / Vite)...
start "Frontend Service" cmd /k "cd /d %FRONTEND_DIR% && npm run dev"
